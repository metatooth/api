<template>
  <section class="section">
      <nav class="level">
        ...
        <div class="level-item has-centered-text">
          <input v-model="calories" type="number" placeholder="Calories" @keyup.enter="save()" />
        </div>
        <div class="level-item has-centered-text">
        ...
        <table class="table">
          ...
          <tbody>
            <tr v-for="meal in meals" 
              ...
              <td>
                <a class="button is-primary" @click="edit(meal)">
                  <span class="icon">
                    <i class="fas fa-edit"></i>
                  </span>
                </a>
                &nbsp;
                <a class="button is-danger" @click="remove(meal)">
                  <span class="icon">
