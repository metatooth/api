...
class User < Model
  ...
  attr_accessor :preferred_working_hours_per_day
  ...
  def create
    if @id.nil? && valid? == true
      ...
      doc_ref.set(type: @type, username: @username.upcase, created: @created,
                  preferred_working_hours_per_day: @preferred_working_hours_per_day, password_salt: @password_salt,
  ...
  def init_from_snap(snap)
    ...
    @preferred_working_hours_per_day = snap.get('preferred_working_hours_per_day').to_i
  ...
  def init_from_hash(params)
    ...
    @preferred_working_hours_per_day = params[:preferred_working_hours_per_day]
  ...
  def to_json(*_args)
    {
      ...
      preferred_working_hours_per_day: @preferred_working_hours_per_day,
